    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="asal_daerah" name="asal_daerah" required>
            ...
            <label for="asal_daerah_custom" class="form-label">Asal Daerah Lainnya</label>
                ...
                <div class="form-text">Masukkan asal daerah dengan huruf kapital tanpa karakter khusus.</div>
            </div>
